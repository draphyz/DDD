...
--------------------------------------------------------
  ...
  CREATE TABLE TEST.EVENT 
   (	EVENTID NUMBER(19,0), 
	...
	COMMITID RAW(16), 
	OCCURREDON TIMESTAMP (6), 
	SUBJECT VARCHAR2(100 CHAR), 
	BODY XMLTYPE, 
	DISPATCHED NUMBER(1,0)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE USERS 
 XMLTYPE COLUMN BODY STORE AS BASICFILE CLOB (
...
--------------------------------------------------------
  ...
  CREATE TABLE TEST.PRESCMEDICATION 
   (	PRESCMEDICATIONID NUMBER(10,0), 
	...
	QUANTITY VARCHAR2(100 CHAR), 
	QUANTITYNUM NUMBER(3,0), 
...
--------------------------------------------------------
  ...
  CREATE TABLE TEST.PRESCRIPTION 
   (	PRESCRIPTIONID NUMBER(10,0), 
	...
	ISELECTRONIC NUMBER(1,0), 
	ELECTRONICNUM VARCHAR2(25 CHAR), 
	CREATEDON DATE, 
	DELIVRABLEAT DATE, 
	...
	PATIENTOLDID NUMBER(10,0), 
	FACILITYID NUMBER(10,0), 
	FACILITYTYPE VARCHAR2(20 CHAR), 
	FACILITYNAME VARCHAR2(100 CHAR), 
	FACILITYLICENSENUM VARCHAR2(25 CHAR), 
	FACILITYCODE VARCHAR2(25 CHAR)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
/
--------------------------------------------------------
--  DDL for Table PARAM_CACHET
--------------------------------------------------------

  CREATE TABLE TEST.PARAM_CACHET 
   (	USERNUM NUMBER(10,0), 
	SITENUM NUMBER(10,0), 
	SITENAME NUMBER(10,0) DEFAULT 0, 
	OPHTALMO NUMBER(10,0) DEFAULT 1, 
	TEL1 NUMBER(10,0) DEFAULT 1, 
	TEL2 NUMBER(10,0) DEFAULT 0, 
	ADRESSE NUMBER(10,0) DEFAULT 1, 
	NUMLOC NUMBER(10,0) DEFAULT 1, 
	MAIL1 NUMBER(10,0) DEFAULT 0, 
	MAIL2 NUMBER(10,0) DEFAULT 0, 
	WEB1 NUMBER(10,0) DEFAULT 0, 
	WEB2 NUMBER(10,0) DEFAULT 0, 
	CENTRE NUMBER(10,0) DEFAULT 0
   ) SEGMENT CREATION IMMEDIATE
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  TABLESPACE USERS
/
...
/
--------------------------------------------------------
--  DDL for Index PK_PARAM_CACHET
--------------------------------------------------------

  CREATE UNIQUE INDEX TEST.PK_PARAM_CACHET ON TEST.PARAM_CACHET (USERNUM, SITENUM) 
...
/
  ...
  ALTER TABLE TEST.EVENT MODIFY (COMMITID NOT NULL ENABLE)
/
 
  ALTER TABLE TEST.EVENT MODIFY (OCCURREDON NOT NULL ENABLE)
/
 
  ALTER TABLE TEST.EVENT MODIFY (DISPATCHED NOT NULL ENABLE)
/
...
/
  ...
  ALTER TABLE TEST.PRESCRIPTION MODIFY (ISELECTRONIC NOT NULL ENABLE)
/
...
/
  ...
  ALTER TABLE TEST.PRESCRIPTION MODIFY (FACILITYID NOT NULL ENABLE)
/
 
  ALTER TABLE TEST.PRESCRIPTION MODIFY (FACILITYTYPE NOT NULL ENABLE)
/
 
  ALTER TABLE TEST.PRESCRIPTION MODIFY (FACILITYNAME NOT NULL ENABLE)
/
--------------------------------------------------------
--  Constraints for Table PARAM_CACHET
--------------------------------------------------------

  ALTER TABLE TEST.PARAM_CACHET ADD CONSTRAINT PK_PARAM_CACHET PRIMARY KEY (USERNUM, SITENUM)
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS NOCOMPRESS LOGGING
  TABLESPACE USERS  ENABLE
/
 
  ALTER TABLE TEST.PARAM_CACHET MODIFY (USERNUM NOT NULL ENABLE)
/
 
  ALTER TABLE TEST.PARAM_CACHET MODIFY (SITENUM NOT NULL ENABLE)
/
 
  ALTER TABLE TEST.PARAM_CACHET MODIFY (SITENAME NOT NULL ENABLE)
/
 
  ALTER TABLE TEST.PARAM_CACHET MODIFY (OPHTALMO NOT NULL ENABLE)
/
 
  ALTER TABLE TEST.PARAM_CACHET MODIFY (TEL1 NOT NULL ENABLE)
/
 
  ALTER TABLE TEST.PARAM_CACHET MODIFY (TEL2 NOT NULL ENABLE)
/
 
  ALTER TABLE TEST.PARAM_CACHET MODIFY (ADRESSE NOT NULL ENABLE)
/
 
  ALTER TABLE TEST.PARAM_CACHET MODIFY (NUMLOC NOT NULL ENABLE)
/
 
  ALTER TABLE TEST.PARAM_CACHET MODIFY (MAIL1 NOT NULL ENABLE)
/
 
  ALTER TABLE TEST.PARAM_CACHET MODIFY (MAIL2 NOT NULL ENABLE)
/
 
  ALTER TABLE TEST.PARAM_CACHET MODIFY (WEB1 NOT NULL ENABLE)
/
 
  ALTER TABLE TEST.PARAM_CACHET MODIFY (WEB2 NOT NULL ENABLE)
/
 
  ALTER TABLE TEST.PARAM_CACHET MODIFY (CENTRE NOT NULL ENABLE)
/
