...
GO
INSERT [dbo].[PrescMedication] ([PrescMedicationId], [PrescriptionId], [MedicationType], [NameOrDesc], [Posology], [Quantity], [Duration], [Code]) VALUES (1, 1, N'Product', N'Latansoc Mylan Coll. 2,5 ml X 3', N'1 goutte le soir', N'1 boîte de 3 flacons', NULL, NULL)
GO
INSERT [dbo].[PrescMedication] ([PrescMedicationId], [PrescriptionId], [MedicationType], [NameOrDesc], [Posology], [Quantity], [Duration], [Code]) VALUES (2, 1, N'Product', N'Dualkopt Coll. 10 ml', N'1 goutte 2 x/jour', N'1 flacon', NULL, N'3260072')
GO