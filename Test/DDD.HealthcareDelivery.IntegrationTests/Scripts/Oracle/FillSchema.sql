...
/
--------------------------------------------------------
--  DDL for Table STOREDEVENT
--------------------------------------------------------

  CREATE TABLE TEST.STOREDEVENT 
   (	EVENTID NUMBER(19,0), 
...
/
--------------------------------------------------------
--  DDL for Index PK_STOREDEVENT
--------------------------------------------------------

  CREATE UNIQUE INDEX TEST.PK_STOREDEVENT ON TEST.STOREDEVENT (EVENTID) 
...
/
--------------------------------------------------------
--  Constraints for Table STOREDEVENT
--------------------------------------------------------

  ALTER TABLE TEST.STOREDEVENT ADD CONSTRAINT PK_STOREDEVENT PRIMARY KEY (EVENTID)
...
/
  ...
  ALTER TABLE TEST.STOREDEVENT MODIFY (EVENTID NOT NULL ENABLE)
/
 
  ALTER TABLE TEST.STOREDEVENT MODIFY (EVENTTYPE NOT NULL ENABLE)
/

  ALTER TABLE TEST.STOREDEVENT MODIFY (VERSION NOT NULL ENABLE)
/
 
  ALTER TABLE TEST.STOREDEVENT MODIFY (UNIQUEID NOT NULL ENABLE)
/
 
  ALTER TABLE TEST.STOREDEVENT MODIFY (OCCURREDON NOT NULL ENABLE)
/
 
  ALTER TABLE TEST.STOREDEVENT MODIFY (ISDISPATCHED NOT NULL ENABLE)
/
 
  ALTER TABLE TEST.STOREDEVENT MODIFY (BODY NOT NULL ENABLE)
/
--------------------------------------------------------
...
/
--------------------------------------------------------
--  DDL for Trigger TR_STOREDEVENT
--------------------------------------------------------
create or replace trigger TEST.TR_STOREDEVENT
before insert on TEST.STOREDEVENT for each row 
begin 
