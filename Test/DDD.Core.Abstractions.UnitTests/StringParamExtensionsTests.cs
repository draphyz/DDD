...
namespace DDD
{
    public class StringParamExtensionsTests
    {
        ...
        {
            // Act
            Action hasMinLength = () => Ensure.That(value, nameof(value)).HasMinLength(minLength);
            // Assert
        ...
        {
            // Act
            Action isAllDigits = () => Ensure.That(value, nameof(value)).IsAllDigits();
            // Assert
        ...
        {
            // Act
            Action isAllLetters = () => Ensure.That(value, nameof(value)).IsAllLetters();
            // Assert
