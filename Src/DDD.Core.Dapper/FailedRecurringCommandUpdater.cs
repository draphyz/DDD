...
namespace DDD.Core.Infrastructure.Data
{
        ...
        where TContext : BoundedContext
    {
        ...
        public void Handle(MarkRecurringCommandAsFailed command, IMessageContext context)
        {
        ...
        public async Task HandleAsync(MarkRecurringCommandAsFailed command, IMessageContext context)
        {
            Ensure.That(command, nameof(command)).IsNotNull();
