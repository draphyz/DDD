...
namespace DDD.Core.Infrastructure.Data
{
        ...
        where TContext : BoundedContext
    {
        ...
        public IEnumerable<Event> Handle(ReadEventStream query, IMessageContext context)
        {
        ...
        public async Task<IEnumerable<Event>> HandleAsync(ReadEventStream query, IMessageContext context)
        {
            Ensure.That(query, nameof(query)).IsNotNull();
