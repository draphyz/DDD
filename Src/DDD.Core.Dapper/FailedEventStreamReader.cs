...
namespace DDD.Core.Infrastructure.Data
{
        ...
        where TContext : BoundedContext
    {
        ...
        public IEnumerable<Event> Handle(ReadFailedEventStream query, IMessageContext context)
        {
        ...
        public async Task<IEnumerable<Event>> HandleAsync(ReadFailedEventStream query, IMessageContext context)
        {
            Ensure.That(query, nameof(query)).IsNotNull();
