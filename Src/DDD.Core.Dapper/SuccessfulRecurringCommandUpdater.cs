...
namespace DDD.Core.Infrastructure.Data
{
        ...
        where TContext : BoundedContext
    {
        ...
        public void Handle(MarkRecurringCommandAsSuccessful command, IMessageContext context = null)
        {
        ...
        public async Task HandleAsync(MarkRecurringCommandAsSuccessful command, IMessageContext context = null)
        {
            Condition.Requires(command, nameof(command)).IsNotNull();
            try
            {
