...
namespace DDD.Core.Infrastructure.Data
{
        ...
        where TContext : BoundedContext
    {
        ...
        public void Handle(UpdateFailedEventStreamPosition command, IMessageContext context = null)
        {
        ...
        public async Task HandleAsync(UpdateFailedEventStreamPosition command, IMessageContext context = null)
        {
            Ensure.That(command, nameof(command)).IsNotNull();
            try
            {
