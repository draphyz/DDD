...
namespace DDD.Core.Infrastructure.Data
{
        ...
        where TContext : BoundedContext
    {
        ...
        public void Handle(SubscribeToEventStream command, IMessageContext context)
        {
        ...
        public async Task HandleAsync(SubscribeToEventStream command, IMessageContext context)
        {
            Ensure.That(command, nameof(command)).IsNotNull();
