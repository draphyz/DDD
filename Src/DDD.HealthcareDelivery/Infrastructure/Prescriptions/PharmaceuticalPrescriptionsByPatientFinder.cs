...
namespace DDD.HealthcareDelivery.Infrastructure.Prescriptions
{
        ...
        : IQueryHandler<FindPharmaceuticalPrescriptionsByPatient, IEnumerable<PharmaceuticalPrescriptionSummary>>
    {
        ...
        public IEnumerable<PharmaceuticalPrescriptionSummary> Handle(FindPharmaceuticalPrescriptionsByPatient query, IMessageContext context)
        {
        ...
        public async Task<IEnumerable<PharmaceuticalPrescriptionSummary>> HandleAsync(FindPharmaceuticalPrescriptionsByPatient query, IMessageContext context)
        {
            Ensure.That(query, nameof(query)).IsNotNull();
